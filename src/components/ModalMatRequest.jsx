...
function ModalMatRequest({ mode, request, open, handleClose, requests = [], materials}) {
    //state
                        ...
                        <List>
                            {requests.map((req, index) => {
                                return (
                                    <ListItem
                                        key={index}
                                        secondaryAction={req.status != "reviewed"?
                                            (<Typography
                                                variant="button"
                                                gutterBottom
                                            >
                                            ...
                                            (<Button variant="contained" value={req.id} onClick={completeRequest}>Receive</Button>)
                                        }
                                    >
                                        <ListItemButton>
                                            <ListItemText
                        ...
                        {mode == "new" && (
                            ...
                            >
                                {materials.map((mat, index)=>(
                                    <MenuItem key={index} value={mat.id}>{mat.name}</MenuItem>
                                ))}
                            </Select>
                          </FormControl>
                        )}
