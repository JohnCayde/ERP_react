    ...
    return (
        <Box>
            ...
            <Box my={4}>
                ...
                <Typography variant="body2" gutterBottom>
                    Diagram below show how is the relationship between each
                    department. The web app are build based on the relationship
                    shown.
                </Typography>
                <img
                    src="../../img/4862c/concept.png"
                    alt="Concept"
                    width="1100"
                />
            </Box>
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={4}>
                            <CustomCard>
                                ...
                                <List>
                                    ...
                                    <CardDescription>
                                        Take overview on all available stock in
                                        material store
                                    </CardDescription>
                                    <CardDescription>
                                        Take overview on all available stock in
                                    ...
                                    <CardDescription>
                                        Handle request from production for
                                        material
                                    </CardDescription>
                                    <CardDescription>
                                        Handle request/receive to purchasing
                                        department for material purchase
                                    </CardDescription>
                                    <CardSubTitle>
                                        Finish Good Store
                                    </CardSubTitle>
                                    <CardDescription>
                                        Receive finish good complete by
                                        production into store
                                    </CardDescription>
                                </List>
                            </CustomCard>
                        </Grid>
                        <Grid item xs={4}>
                            <CustomCard>
                                ...
                                <List>
                                    ...
                                    <CardDescription>
                                        Handle material that are qualified to
                                        process product
                                    </CardDescription>
                                    <CardSubTitle>Process</CardSubTitle>
                                    <CardDescription>
                                        Handle process that are qualified to
                                        process product
                                    </CardDescription>
                                    <CardDescription>
                                        Handle request/receive to purchasing
                        ...
                        <Grid item xs={4}>
                            <CustomCard>
                                ...
                                <List>
                                    <CardDescription>
                                        Handle orders from sales
                                    </CardDescription>
                                    <CardDescription>
                                        Constrcut planning and provide
                        ...
                        <Grid item xs={4}>
                            <CustomCard>
                                ...
                                <List>
                                    ...
                                    <CardDescription>
                                        Add/remove machine for each section in
                                        production
                                    </CardDescription>
                                    <CardSubTitle>{"<Process>"}</CardSubTitle>
                                    <CardDescription>
                        ...
                        <Grid item xs={4}>
                            <CustomCard>
                                ...
                                <List>
                                    <CardDescription>
                                        Take overview on items that available
                                        got purchase
                                    </CardDescription>
                                    <CardDescription>
                                        Handle purchase request from production
                                        and maintenance
                                    </CardDescription>
                                    <CardDescription>
                                    ...
                                    <CardDescription>
                                        Handle external purchase request with
                                        vendor
                                    </CardDescription>
                                    <CardDescription>
                        ...
                        <Grid item xs={4}>
                            <CustomCard>
                                ...
                                <List>
                                    <CardDescription>
                                        Take overview on maintenance request
                                        from production
                                    </CardDescription>
                                    <CardDescription>
                                        Review incoming production maintenance
                                        request
                                    </CardDescription>
                                    <CardDescription>
                                        Complete existing production maintenance
                                        record
                                    </CardDescription>
                                    <CardDescription>
                                    ...
                                    <CardDescription>
                                        Send tool purchase request to purchasing
                                        department
                                    </CardDescription>
                                    <CardDescription>
                                        Receive tool purchased and resolve
                                        purchase request
                                    </CardDescription>
                                </List>
                            </CustomCard>
                        ...
                        <Grid item xs={4}>
                            <CustomCard>
                                ...
                                <List>
                                    <CardDescription>
                                        Take overview on all available issue
                                        note
                                    </CardDescription>
                                    <CardDescription>
