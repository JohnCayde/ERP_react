...
function ProdConDashBoard({
  ...
  products: Array<EngineerTypes.ProductModel>;
  pending: Array<ProductionTypes.Component>;
  processing: Array<ProductionTypes.Component>;
  prodStock: Array<StoreTypes.TransactionModel>;
  stock: Array<StoreTypes.TransactionModel>;
}) {
        ...
        <TableBody>
          {components.map((component, index) => (
            ...
            >
              ...
              <TableCell align="right">{component.pending}</TableCell>
              <TableCell align="right">{component.processing}</TableCell>
              <TableCell align="right">{component.prodStock}</TableCell>
              <TableCell align="right">{component.stock}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
