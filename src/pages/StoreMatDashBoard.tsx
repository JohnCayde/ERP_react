...
function StoreMatDashBoard({
  inventory,
}: {
  inventory: Array<StoreTypes.MaterialModel>;
}) {
  ...
  const handleMatName = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const handleQty = (e: React.ChangeEvent<HTMLInputElement>) => {
    setQty(parseInt(e.target.value as string));
  };
    ...
    <Box sx={{ height: 600, width: "100%" }}>
      ...
      >
        <Box sx={style}>
          ...
          <Box display="flex" justifyContent="end">
            <Button sx={{ my: 2 }} variant="contained" onClick={addMaterial}>
              Confirm
            </Button>
          </Box>
        </Box>
      ...
      >
        <Box sx={style}>
          ...
          <Box display="flex" justifyContent="end">
            <Button sx={{ mx: 2 }} variant="contained" onClick={adjMaterial}>
              Confirm
            </Button>
          </Box>
        </Box>
