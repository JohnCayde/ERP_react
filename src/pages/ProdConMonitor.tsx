          ...
          <TableBody>
            {sectionStatistic.map((section, index) => (
              ...
              >
                ...
                <TableCell align="right">{section.planning}</TableCell>
                <TableCell align="right">{section.pending.length}</TableCell>
                <TableCell align="right">{section.processing.length}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
