...
function StoreMatPurReceive({allRequests}) {
        ...
        <Box my={1}>
            <Box>
                ...
                <Typography variant="caption" display="block" gutterBottom>
                    （Receive material that already purchase by purchasing department)
                </Typography>
            </Box>
                    ...
                    <TableBody>
                        {requests.map((request, index) => (
                            ...
                            >
                                ...
                                <TableCell align="right">
                                    {request.status == "reviewed" && <Button
                                        variant="contained"
                                        value={request.id}
                                        onClick={comRequest}
                                    >
...
export default StoreMatPurReceive
