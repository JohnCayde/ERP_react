...
export default function(state = initialState, action) {
    switch (action.type) {
        case Purchaser.ADD_PURCHASE_ORDER:
            return {
                ...state,
                purchaseOrders: [...state.purchaseOrders, action.payload]
            };
        case Purchaser.DEL_PURCHASE_ORDER:
        ...
        case Purchaser.REV_PURCHASE_ORDER:
        ...
        case Purchaser.ADD_REQUEST:
                return {
                    ...state,
                    requests:[...state.requests, action.payload]
                }
        case Purchaser.REV_REQUEST:
