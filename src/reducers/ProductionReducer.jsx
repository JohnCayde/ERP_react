...
export default function(state = initialState, action){
    switch (action.type) {
        case production.ADD_SECTION:
            return {
                ...state,
                sections: [ state.sections, action.payload]
            }
        case production.DEL_SECTION:
            const sections = state.sections.filter(section=>section.id != action.payload)
            return {
                ...state,
                sections
            }
        case production.ADD_MACHINE:
            return {
                ...state,
                machines: [...state.machines, action.payload]
            }
        case production.DEL_MACHINE:
            const machines = state.machines.filter(machine=>machine.id != action.payload)
            return {
                ...state,
                machines
            }
        case production.START_PROCESS:
        case production.COMPLETE_PROCESS:
        ...
        case production.ADD_COMPONENT:
            return {
                ...state,
                components: [...state.components, ...action.payload]
            }
        case production.HANDLE_PLANNING:
